  ...
  return (
    <div className="flex flex-col">
      ...
      >
        ...
        <div className="hero-content text-center text-neutral-content">
          <div className="max-w-md">
            ...
            <p className="mb-5 text-white">Based in bustling Jakarta!</p>
          </div>
        </div>
      </div>
      <div>
        ...
        <div className="grid grid-cols-2 gap-0">
          <div className="bg-white h-1/2 border-x-2 border-white-400">
            ...
            <h1 className="text-md text-center text-black px-10 text-justify">
              HIV is a virus that attacks the immune system of the body. If not
      ...
      >
        ...
        <div className="hero-content text-center text-neutral-content">
          <div className="max-w-md">
            ...
            <p className="mb-5 text-white">Coming Soon!</p>
          </div>
        </div>
      </div>
      <br />
      ...
      >
        ...
        <div className="hero-content text-center text-neutral-content">
          <div className="max-w-md">
            <h1 className="mb-5 text-6xl font-bold text-white">Sponsorhips</h1>
            <p className="mb-5 text-white">Credits</p>
          </div>
        </div>
      </div>
      <br />
